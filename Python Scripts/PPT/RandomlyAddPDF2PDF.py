...
def add_pdfs_to_pdf(template_pdf_path, pdf_folder=None, output_pdf_path=None):
    if pdf_folder is None:
        pdf_folder = r"C:\Users\ahmad\OneDrive\Computer Files\Programming\1.0 - MacroBook\Ink Temp"
